...
public class MathUtil {
   ...
   public static BigDecimal getMultiply(BigDecimal price,int count,int digit) {
     ...
     * @return  double
     */
    public static double mathTodecimaltwo(double math){
        BigDecimal b = new BigDecimal(String.valueOf(math));
        b=b.setScale(2, BigDecimal.ROUND_HALF_UP); //小数位后2位四舍五入
     ...
     * @return  double
     */
    public static double mathTodecimaltwoCapture(double math){
