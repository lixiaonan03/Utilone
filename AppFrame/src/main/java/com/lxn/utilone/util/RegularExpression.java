...
public class RegularExpression {
	...
	//全字母或数字、汉字   [\u4e00-\u9fa5a-zA-Z0-9\-\——]{4,20} 4-20位字母数字
	...
	//手机号码格式
	public static final String MOBILE_PHONE = "^(13[0-9]|15[0-9]|18[0-9]|17[0-9]|14[0-9])\\d{8}$";
	//中国移动手机号码格式
	public static final String MOBILE_PHONE_CHINA_MOBILE = "^(13[4-9]|147|15[012789]|18[23478])\\d{8}$";
