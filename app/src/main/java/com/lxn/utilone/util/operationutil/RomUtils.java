...
/**
  *  @author lixiaonan
  *  功能描述: rom管理工具类获取当前rom是啥类型
  *  时 间： 2019-11-04 19:45
  */
public final class RomUtils {
     ...
     * @return
     */
    public static int getFlymeVersionCode(String version) {
        int code = 0;
     ...
     * @return
     */
    public static int getMIUIVersionCode(String version) {
        int code = -1;
        try {
            version = version.trim().toUpperCase().replace("V", "");
