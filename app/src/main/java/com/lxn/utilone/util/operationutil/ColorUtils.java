...
public final class ColorUtils {
    ...
    /**
     * 设置颜色透明度值 eg: ColorUtils.setAlphaComponent(0xffffffff, 0x80)
     * @param color The color.
     * @param alpha Alpha component \([0..255]\) of the color.
     * @return the {@code color} with {@code alpha} component
     */
    public static int setAlphaComponent(@ColorInt final int color, @IntRange(from = 0x0, to =
            0xFF) int alpha) {
